...
case class SpObject(potr: Potr, sp: SpEntity, mrFirst: MrEntity, mrLast: MrEntity, regList: List[(RegEntity,Potr)])

case class ObjectModel(potr: Potr, sp: SpEntity, sa:SaEntity, mrFirst:MrEntity, mrLast:MrEntity, regList: List[(RegEntity,Potr)])
